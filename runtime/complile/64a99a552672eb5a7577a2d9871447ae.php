...
<div class="layui-body">
	  ...
	  <div class="layui-tab-content">
	  	   <div class="layui-tab-item layui-show">
	  	     ...
	  	     <div class="layui-tab-item">
	  	     	<form action="<?php echo \core\basic\Url::get('/admin/ContentSort/add');?>" method="post" class="layui-form" lay-filter="sortAdd">
		  	     	<input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 
		  	     	<div class="layui-tab">
					  <ul class="layui-tab-title">
					  ...
					  <div class="layui-tab-content">
					    <div class="layui-tab-item layui-show">
			                ...
			                <div class="layui-form-item">
			                     ...
			                     <div class="layui-input-block">
			                     	<input type="text" name="name" required lay-verify="required" lay-reqText="栏目名称不能为空" placeholder="请输入栏目名称" class="layui-input">
			                     </div>
			                </div>
			                ...
			                <div class="layui-form-item">
			                     ...
			                     <div class="layui-input-block">
			                     	<select name="mcode" lay-filter="model" lay-verify="required" lay-reqText="请选择内容模型">
	  	     ...
	  	     <!-- 批量新增 -->
	  	     <div class="layui-tab-item">
	  	     	<form action="<?php echo \core\basic\Url::get('/admin/ContentSort/add');?>" method="post" class="layui-form" lay-filter="sortBatch">
		  	     		<input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 
		  	     		<div class="layui-form-item">
		                     <label class="layui-form-label">父栏目</label>
		                     <div class="layui-input-block">
		                ...
		                <div class="layui-form-item">
		                     ...
		                     <div class="layui-input-block">
		                     	<input type="text" name="multiplename" required lay-verify="required" lay-reqText="栏目名称不能为空" placeholder="请输入栏目名称，多个栏目用逗号隔开" class="layui-input">
		                     </div>
		                </div>
	...
	<div class="layui-tab layui-tab-brief" lay-filter="tab">
	  ...
	  <div class="layui-tab-content">
	  	<div class="layui-tab-item layui-show">
	  		<form action="<?php echo \core\basic\Url::get('/admin/ContentSort/mod/scode/'.get('scode').'');?><?php echo $this->getVar('backurl');?>" method="post" class="layui-form" lay-filter="sortMod">
	  	     	<input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 
	  	     	<div class="layui-tab">
				  <ul class="layui-tab-title">
				    <li class="layui-this">基本选项</li>
				  ...
				  <div class="layui-tab-content">
				    <div class="layui-tab-item layui-show">
		                ...
		                <div class="layui-form-item">
		                     <label class="layui-form-label">栏目名称  <span class="layui-text-red">*</span></label>
		                     <div class="layui-input-block">
		                     	<input type="text" name="name" value="<?php echo @$this->getVar('sort')->name;?>" required lay-verify="required" lay-reqText="栏目名称不能为空" placeholder="请输入栏目名称" class="layui-input">
		                     </div>
		                </div>
